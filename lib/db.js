...
DB.prototype._dropTable = function (req) {
    ...
    if (hasStatic) {
        return this.client.exec_p('drop table ' + dbu.cassID(keyspace+"_data") + 
                                      "; drop table" + dbu.cassID(keyspace+"_meta") +
                                      "; drop table" + dbu.cassID(keyspace+"_data_static"));
    }
    return this.client.exec_p('drop table ' + dbu.cassID(keyspace+"_data") + "; drop table" + dbu.cassID(keyspace+"_meta"));
}
